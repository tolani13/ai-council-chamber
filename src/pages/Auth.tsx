  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background">
      <div className="flex justify-center w-full max-w-[520px] mb-8">
        <img src={politburoLogo} alt="Politburo" className="w-full h-auto mix-blend-lighten" draggable={false} />
      </div>
      ...
      <div className="w-full max-w-sm space-y-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" disabled={submitting} className="w-full">
            {submitting ? "Processing..." : view === "signup" ? "Create Account" : view === "forgot" ? "Send Reset Link" : "Sign In"}
          </Button>
        </form>
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <button onClick={() => setView(view === "signup" ? "signin" : view === "forgot" ? "signin" : "signup")} className="text-gold hover:underline font-medium">
